...
String sql1="insert into user ( username,password) values ('" +txt_username.getText()+ "','" +txt_password.getText()+ "')";
...
System.exit(0);        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{ 
               ...
               if(txt_username.equals("nifars")&& txt_password.equals("nifarspwd")){
